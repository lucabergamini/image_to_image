...
if __name__ == "__main__":
    ...
    for i in range(n_epochs):
        ...
        for j, (data_X,data_Y) in enumerate(zip(dataloader_X, dataloader_Y)):
            ...
            # FORWARD AUTOENCODER
            ten_original_X, ten_original_Y,ten_X_Y,ten_Y_X, ten_X_Y_X, ten_Y_X_Y, l1_G, loss_gan_autoencoder_G, l1_F, loss_gan_autoencoder_F,loss_identity_G,loss_identity_F  = net(data_X,data_Y,mode="autoencoder")
            # BACKWARD AUTOENCODER
            optimizer_autoencoder.zero_grad()
            (lambda_mse * (l1_G + l1_F+lambda_identity*(loss_identity_G+loss_identity_F)) + loss_gan_autoencoder_G + loss_gan_autoencoder_F).backward()
